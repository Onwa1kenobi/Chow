package io.julius.chow.main.image;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        builder.setTitle(context.getString(R.string.set_banner_image));

        // add a list
        String[] animals = {context.getString(R.string.take_camera_picture), context.getString(R.string.choose_from_gallery)};
